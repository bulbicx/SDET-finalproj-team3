...
INSERT INTO `track` (`duration`, `lyrics`, `name`, `album_id`, `playlist_id`) VALUES (180, 'la la la land', 'Parkour', 1, 1);
INSERT INTO `playlist_track` (`id`, `playlist_id`, `track_id`) VALUES (1, 1, 1);
